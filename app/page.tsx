    ...
    <main className="bg-[#FFFBD2] font-body-md text-on-surface selection:bg-primary selection:text-white overflow-x-hidden min-h-screen">
      ...
      <nav className="sticky top-0 z-50 bg-[#FFFBD2]/90 backdrop-blur-md border-b border-outline-variant/30">
        <div className="max-w-[1200px] mx-auto px-4 md:px-6 h-20 flex justify-between items-center">
          ...
          <button className="whatsapp-pulse flex items-center gap-2 bg-whatsapp text-white px-6 py-3 rounded-lg font-label-caps text-xs tracking-widest font-bold hover:scale-105 transition-all active:opacity-80">
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="group bg-surface-container-lowest heritage-border p-4 transition-all hover:-translate-y-2">
              ...
              <button className="w-full flex items-center justify-center gap-2 bg-whatsapp text-white py-3 font-label-caps text-[11px] font-bold tracking-widest rounded transition-transform hover:scale-105 active:scale-95">
          ...
          <div className="bg-surface/10 backdrop-blur-md p-12 md:p-20 text-center heritage-border relative overflow-hidden rounded-2xl">
            ...
            <div className="max-w-3xl mx-auto relative z-10">
              ...
              <div className="flex flex-col items-center gap-6">
                <button className="bg-whatsapp text-white px-12 py-5 rounded-lg font-headline-sm text-xl font-bold flex items-center gap-4 hover:scale-105 transition-all shadow-xl">
